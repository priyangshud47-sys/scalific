...
const DEFAULT_CONTENT_BLOCKS: DefaultContentBlock[] = [
  ...
  { section_key: "about_page_heading", content: "Built by founders, for founders." },
  { section_key: "about_page_text", content: "Scalific started from a simple frustration: agencies that hand off strategy, design, web, and marketing to four different teams who never talk to each other." },
  { section_key: "about_integrated_heading", content: "The Integrated Approach" },
  { section_key: "about_integrated_text", content: "Every plan we write, site we build, and campaign we run stays connected from the first workshop to the first major growth curve. We act as your fractional growth team, ensuring that your brand narrative remains consistent across every single touchpoint." },
  { section_key: "services_page_heading", content: "Our Services" },
  { section_key: "services_page_text", content: "We don't just build websites; we build scalable digital growth engines. Our core disciplines work in harmony to take your brand from concept to market leader." },
  { section_key: "case_studies_heading", content: "Case Studies" },
  { section_key: "case_studies_subtext", content: "The numbers behind the launch. See how our integrated strategy, design, and marketing approach drives real business outcomes." },
  { section_key: "blog_page_heading", content: "Insights & Resources" },
  { section_key: "blog_page_text", content: "Tactical advice and deep dives into branding, design, and growth marketing." },
